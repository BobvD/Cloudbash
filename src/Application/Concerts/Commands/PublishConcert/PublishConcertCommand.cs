...
namespace Cloudbash.Application.Concerts.Commands.PublishConcert
{
    public class PublishConcertCommand : IRequest
    {
        ...
        public class PublishConcertCommandHandler : IRequestHandler<PublishConcertCommand>
        {
            ...
            public async Task<Unit> Handle(PublishConcertCommand request, CancellationToken cancellationToken)
            {
